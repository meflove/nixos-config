  ...
  flake = _: {
    nixosModules.${baseNameOf ./.} = {
      ...
      system = {
        ...
        preSwitchChecks.detectHostnameChange = lib.mkIf (config.networking.hostName != "") ''
      ...
      services = {
        speechd.enable = false; # NOTE: untested, may break things
      };
      ...
      systemd = {
        ...
        enableStrictShellChecks = true; # CONFIG: will become default
      };
